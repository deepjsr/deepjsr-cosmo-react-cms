...
content_blocks:
  - _name: global/hero
    ...
    subheading: >-
      Lumière Skin began in a Paris apartment with one question: why is clean
      skincare so complicated?
  ...
  - _name: global/content-block
    ...
    content: >-
      <p>We started by mixing serums for friends with reactive skin who were
      tired of choosing between 'natural' and 'effective'. Today every Lumière
      formula is developed with dermatologists, made in small batches, and
      shipped worldwide — without ever compromising on what goes in (or what
      stays out).</p>
  - _name: global/stats
...
seo:
  page_description: >-
    The story behind Lumière Skin — a Paris studio making clean, effective,
    vegan skincare and makeup for real skin.
